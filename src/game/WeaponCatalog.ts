...
export const WEAPONS: WeaponDef[] = [
  w({ id: 'missile', name: 'Missile', packPrice: 0, packQty: 1, category: 'weapons', damage: 32, blastRadius: 12, projectileCount: 1, spreadDeg: 0, special: 'normal', terrainEffect: 'crater', unlockTier: 0 }),
